...
I was unsuccessful in getting this configuration to work in the default Mac Terminal (in an acceptable state), so I recommend using a third-party terminal emulator that supports advanced terminal color features. I use [iTerm2](https://iterm2.com/), but [Kitty](https://sw.kovidgoyal.net/kitty/) and [Alacritty](https://alacritty.org/) should work as well (untested).
